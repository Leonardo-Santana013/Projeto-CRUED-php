            ...
            <div class="card-body">
              <form action="" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="cargo" class="form-control" name="cargo" placeholder="Cargo do funcionario" required>
                </div>
...
if(!empty($_POST))
{
 ...
 try{
   $stmt = $conn->prepare("INSERT INTO funcionario(nome, cpf, celular, cargo) VALUES (:nome,:cpf,:celular,:cargo)");
