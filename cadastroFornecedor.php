            ...
            <div class="card-body">
              <form action="" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="number" class="form-control" name="cnpj" onblur="TestaCPF(this.value);" placeholder="cnpj" required>
                </div>
                <div class="mb-3">
...
if(!empty($_POST))
{
 ...
 try{
   $stmt = $conn->prepare("INSERT INTO fornecedor(nome, cnpj, estado, contato) VALUES (:nome,:cnpj,:estado,:contato)");
